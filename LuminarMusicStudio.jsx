...
export default function LuminarMusicStudio() {
  ...
  const generateSongGeneration = async () => {
    ...
    try {
      const resp = await fetch("https://api-inference.huggingface.co/models/facebook/musicgen-large", {
        method: "POST",
  ...
  const generateDiffRhythm = async () => {
    ...
    try {
      const resp = await fetch("https://api-inference.huggingface.co/models/ASLP-lab/DiffRhythm-full", {
        method: "POST",
        headers: { Authorization: `Bearer ${hfKey}`, "Content-Type": "application/json" },
